 ...
 */
public abstract class PropertiesTranslationLoader extends AbstractTranslationLoader {
     ...
     */
    protected PropertiesTranslationLoader(@NotNull Path directory, @NotNull Locale defaultLocale) {
        super(directory, defaultLocale, ".properties");
    }

    @Override
    protected @NotNull MessageLoader createMessageLoader(@NotNull Path path) {
        return MessageLoader.fromProperties(path);
    }
}
